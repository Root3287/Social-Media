  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <?php if($user->isLoggedIn()):?><li><a href="/search">Search</a></li><?php endif;?>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <!-- Make mail -->
        <?php if($user->isLoggedIn()){?><li><a href="/user?page=notification"><span class="glyphicon glyphicon-inbox"></span><?php if(Notifaction::getUnreadCount($user->data()->id) > 0){?><span class="badge"><?php echo Notifaction::getUnreadCount($user->data()->id);?></span><?php }?></a></li><?php }?>
        <!-- <li class="dropdown">
