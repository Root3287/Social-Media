					...
					<div class="row">
						<form id="status" action="" method="post">
							<div class="form-group">
								<textarea style="resize: none;" class="form-control" name="post_status" id="post_status" rows="10" placeholder="<?php echo $GLOBALS['language']->get('timeline_placeholder');?>"></textarea>
							</div>
							<div class="form-group">
