				...
				<div class="col-md-9">
					...
					?>
						...
						<div class="row">
							...
							<?php if($post->getComments($uPost['id'])){ echo "<hr>";
							...
							<form id="reply" action="" class="form-inline" method="post" autocomplete="off">
								<div class="form-group">
									<div class="input-group">
									   ...
									   <span class="input-group-btn">
									   		<button type="button" class="btn btn-info" data-toggle="modal" data-target="#PostModel<?php echo $uPost['id'];?>">
					      ...
					      <div class="modal-header">
					        ...
					        <span class="pull-right">
						        <div class="dropdown">
								    ...
								    <li><a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo getSelfURL()."/p/".$uPost['hash'];?>">Tweet</a></li>
								    <li><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo getSelfURL()."/p/".$uPost['hash'];?>">Share on Facebook</a></li>
								    <li><a href="/p/<?php echo $uPost['hash'];?>">Post</a></li>
								  </ul>
								</div>
					        </span>
					      </div>
